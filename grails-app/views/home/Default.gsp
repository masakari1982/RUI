...
<head>
    ...
    <g:include view="/layouts/basicStyle.gsp" />
...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-messages">
                            <li class="m-t-xs">
                                <div class="dropdown-messages-box">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="${imagesPath}/a7.jpg">
                                    </a>
                            ...
                            <li>
                                <div class="dropdown-messages-box">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="${imagesPath}/a4.jpg">
                                    </a>
                                    <div class="media-body ">
        ...
        <g:include view="/layouts/_footer.gsp"></g:include>
    </div>
    <!--右侧部分结束-->
            ...
            <div class="tab-content">
                <div id="tab-1" class="tab-pane active">
                    ...
                    <div class="skin-setttings">
                        ...
                        <div class="setings-item angular-skin nb">
                            <span class="skin-name ">
                                <a href="#" class="s-skin-2 block clearfix">
                                    <div class="pull-left" style="width: 50%">
                                        <b style="height:10px; width:100%; background-color:#1199c4; display: block"></b>
                                        <b class="pull-left" style="height:20px; width:50%; background-color:#dde6e9; display: block"></b>
                                        <b class="pull-left" style="height:20px; width:50%; background-color:#edf1f2; display: block"></b>
                                    </div>
                                    <div class="pull-right text-right" style="height: 30px; line-height: 30px">蓝/白色主题</div>
                                </a>
                            </span>
                        </div>
                ...
                <div id="tab-2" class="tab-pane">
                    ...
                    <div>
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="${imagesPath}/a1.jpg">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="${imagesPath}/a2.jpg">
                                </div>
                                <div class="media-body">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="${imagesPath}/a3.jpg">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="${imagesPath}/a4.jpg">
                                </div>
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="${imagesPath}/a8.jpg">
                                </div>
                                <div class="media-body">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="${imagesPath}/a7.jpg">
                                </div>
                                <div class="media-body">
