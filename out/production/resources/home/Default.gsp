...
<div id="wrapper">
            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="/home/linkssss" data-index="0">主页示例一</a>
                        </li>
                        <li>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        <div class="row border-bottom">
            <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                ...
                <g:include view="/layouts/_infoCenter.gsp"></g:include>
            </nav>
        </div>
        ...
        <div class="row J_mainContent" id="content-main">
            <div id="test"></div>
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="/home/dashboard" frameborder="0" data-id=""></iframe>
        </div>
    ...
    <div id="right-sidebar">
        <g:include view="/layouts/_rightBar.gsp"></g:include>
    </div>
    <!--右侧边栏结束-->
