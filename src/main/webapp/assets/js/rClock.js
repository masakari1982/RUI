!(function (win, doc) {
    var clockHtml = '<div class="icon-large icon-clock">\n' +
                    '                <div class="clock">\n' +
                    '                    <ol>\n' +
                    '                        <li></li>\n' +
                    '                        <li></li>\n' +
                    ...
                    '                        <li></li>\n' +
                    '                    </ol>\n' +
                    '                    <div id="div-hour" class="hour"></div>\n' +
                    '                    <div id="div-minute" class="minute"></div>\n' +
                    '                    <div id="div-second" class="second"></div>\n' +
                    '                </div>\n' +
                    '            </div>';

    $('.rclock').html(clockHtml);
    ...
    var start = function () {
        ...
        var now = new Date(),
            ...
            ss = mm * 60;
        // 实现时钟旋转
        hour.style.transform = "rotate(" + (hh * 30 + (hh / 12)) + "deg)";
